...
- `reports/final_visual_evidence/figures/final_locomotif_controlled_summary.png`
- `reports/final_visual_evidence/figures/final_method_object_comparison_diagram.png`
- `reports/final_visual_evidence/figures/final_mp_vs_locomotif_agnostic_1h_side_by_side.png`
- `reports/final_visual_evidence/figures/final_mp_vs_locomotif_counts_and_occurrences.png`
- `reports/final_visual_evidence/figures/final_mp_vs_locomotif_high_vol_side_by_side.png`
- `reports/final_visual_evidence/figures/final_mp_vs_locomotif_low_vol_side_by_side.png`
- `reports/final_visual_evidence/figures/final_mp_vs_locomotif_runtime.png`
- `reports/final_visual_evidence/figures/loco_occurrence_count_by_regime.png`
- `reports/final_visual_evidence/figures/motif_01_locomotif_btcusdt_15m_all_1_0_1_0_context.png`
- `reports/final_visual_evidence/figures/motif_01_locomotif_btcusdt_15m_all_1_0_1_0_normal_pattern.png`
- `reports/final_visual_evidence/figures/motif_01_locomotif_btcusdt_15m_all_1_0_1_0_zoom.png`
- `reports/final_visual_evidence/figures/motif_02_locomotif_btcusdt_15m_all_1_0_3_0_context.png`
- `reports/final_visual_evidence/figures/motif_02_locomotif_btcusdt_15m_all_1_0_3_0_normal_pattern.png`
- `reports/final_visual_evidence/figures/motif_02_locomotif_btcusdt_15m_all_1_0_3_0_zoom.png`
...
- `reports/final_visual_evidence/figures/motif_08_locomotif_btcusdt_1h_agnostic_nan_nan_context.png`
- `reports/final_visual_evidence/figures/motif_08_locomotif_btcusdt_1h_agnostic_nan_nan_normal_pattern.png`
- `reports/final_visual_evidence/figures/motif_08_locomotif_btcusdt_1h_agnostic_nan_nan_zoom.png`
...
- `reports/final_visual_evidence/tables/candlestick_motif_figure_index.csv`
- `reports/final_visual_evidence/tables/final_distribution_plot_sources.csv`
- `reports/final_visual_evidence/tables/final_mp_vs_locomotif_summary.csv`
- `reports/final_visual_evidence/tables/input_inventory.csv`
- `reports/final_visual_evidence/tables/motif_event_context_table.csv`
- `reports/final_visual_evidence/tables/motif_occurrences_with_vix_context.csv`
- `reports/final_visual_evidence/tables/motif_shape_cluster_assignments.csv`
- `reports/final_visual_evidence/tables/shap_skipped_reason.csv`
- `reports/final_visual_evidence/tables/top_motif_gallery_index.csv`
