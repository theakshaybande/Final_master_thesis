...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_03_locomotif_btcusdt_15m_high_vol_nan_nan_context.png}
\caption{motif 03 locomotif btcusdt 15m high vol nan nan context. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_03_locomotif_btcusdt_15m_high_vol_nan_nan_normal_pattern.png}
\caption{motif 03 locomotif btcusdt 15m high vol nan nan normal pattern. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_03_locomotif_btcusdt_15m_high_vol_nan_nan_zoom.png}
\caption{motif 03 locomotif btcusdt 15m high vol nan nan zoom. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_04_locomotif_btcusdt_15m_high_vol_nan_nan_context.png}
\caption{motif 04 locomotif btcusdt 15m high vol nan nan context. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_04_locomotif_btcusdt_15m_high_vol_nan_nan_normal_pattern.png}
\caption{motif 04 locomotif btcusdt 15m high vol nan nan normal pattern. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_04_locomotif_btcusdt_15m_high_vol_nan_nan_zoom.png}
\caption{motif 04 locomotif btcusdt 15m high vol nan nan zoom. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_05_locomotif_btcusdt_15m_low_vol_nan_nan_context.png}
\caption{motif 05 locomotif btcusdt 15m low vol nan nan context. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_05_locomotif_btcusdt_15m_low_vol_nan_nan_normal_pattern.png}
\caption{motif 05 locomotif btcusdt 15m low vol nan nan normal pattern. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_05_locomotif_btcusdt_15m_low_vol_nan_nan_zoom.png}
\caption{motif 05 locomotif btcusdt 15m low vol nan nan zoom. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_06_locomotif_btcusdt_15m_low_vol_nan_nan_context.png}
\caption{motif 06 locomotif btcusdt 15m low vol nan nan context. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_06_locomotif_btcusdt_15m_low_vol_nan_nan_normal_pattern.png}
\caption{motif 06 locomotif btcusdt 15m low vol nan nan normal pattern. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_06_locomotif_btcusdt_15m_low_vol_nan_nan_zoom.png}
\caption{motif 06 locomotif btcusdt 15m low vol nan nan zoom. The figure compares real available Matrix Profile and LoCoMotif outputs while preserving object-type differences.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_09_matrix_profile_btcusdt_15m_all_1_0_pair35_1_context.png}
\caption{motif 09 matrix profile btcusdt 15m all 1 0 pair35 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_09_matrix_profile_btcusdt_15m_all_1_0_pair35_1_normal_pattern.png}
\caption{motif 09 matrix profile btcusdt 15m all 1 0 pair35 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_09_matrix_profile_btcusdt_15m_all_1_0_pair35_1_zoom.png}
\caption{motif 09 matrix profile btcusdt 15m all 1 0 pair35 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_10_matrix_profile_btcusdt_15m_all_1_0_pair35_2_context.png}
\caption{motif 10 matrix profile btcusdt 15m all 1 0 pair35 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_10_matrix_profile_btcusdt_15m_all_1_0_pair35_2_normal_pattern.png}
\caption{motif 10 matrix profile btcusdt 15m all 1 0 pair35 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_10_matrix_profile_btcusdt_15m_all_1_0_pair35_2_zoom.png}
\caption{motif 10 matrix profile btcusdt 15m all 1 0 pair35 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_11_matrix_profile_btcusdt_15m_high_vol_1_0_pair19_1_context.png}
\caption{motif 11 matrix profile btcusdt 15m high vol 1 0 pair19 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_11_matrix_profile_btcusdt_15m_high_vol_1_0_pair19_1_normal_pattern.png}
\caption{motif 11 matrix profile btcusdt 15m high vol 1 0 pair19 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_11_matrix_profile_btcusdt_15m_high_vol_1_0_pair19_1_zoom.png}
\caption{motif 11 matrix profile btcusdt 15m high vol 1 0 pair19 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_12_matrix_profile_btcusdt_15m_high_vol_1_0_pair19_2_context.png}
\caption{motif 12 matrix profile btcusdt 15m high vol 1 0 pair19 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_12_matrix_profile_btcusdt_15m_high_vol_1_0_pair19_2_normal_pattern.png}
\caption{motif 12 matrix profile btcusdt 15m high vol 1 0 pair19 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_12_matrix_profile_btcusdt_15m_high_vol_1_0_pair19_2_zoom.png}
\caption{motif 12 matrix profile btcusdt 15m high vol 1 0 pair19 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_13_matrix_profile_btcusdt_15m_low_vol_nan_pair4_1_context.png}
\caption{motif 13 matrix profile btcusdt 15m low vol nan pair4 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_13_matrix_profile_btcusdt_15m_low_vol_nan_pair4_1_normal_pattern.png}
\caption{motif 13 matrix profile btcusdt 15m low vol nan pair4 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_13_matrix_profile_btcusdt_15m_low_vol_nan_pair4_1_zoom.png}
\caption{motif 13 matrix profile btcusdt 15m low vol nan pair4 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_14_matrix_profile_btcusdt_15m_low_vol_nan_pair4_2_context.png}
\caption{motif 14 matrix profile btcusdt 15m low vol nan pair4 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_14_matrix_profile_btcusdt_15m_low_vol_nan_pair4_2_normal_pattern.png}
\caption{motif 14 matrix profile btcusdt 15m low vol nan pair4 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_14_matrix_profile_btcusdt_15m_low_vol_nan_pair4_2_zoom.png}
\caption{motif 14 matrix profile btcusdt 15m low vol nan pair4 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_15_matrix_profile_btcusdt_1h_agnostic_nan_pair1_1_context.png}
\caption{motif 15 matrix profile btcusdt 1h agnostic nan pair1 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_15_matrix_profile_btcusdt_1h_agnostic_nan_pair1_1_normal_pattern.png}
\caption{motif 15 matrix profile btcusdt 1h agnostic nan pair1 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_15_matrix_profile_btcusdt_1h_agnostic_nan_pair1_1_zoom.png}
\caption{motif 15 matrix profile btcusdt 1h agnostic nan pair1 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_16_matrix_profile_btcusdt_1h_agnostic_nan_pair1_2_context.png}
\caption{motif 16 matrix profile btcusdt 1h agnostic nan pair1 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_16_matrix_profile_btcusdt_1h_agnostic_nan_pair1_2_normal_pattern.png}
\caption{motif 16 matrix profile btcusdt 1h agnostic nan pair1 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_16_matrix_profile_btcusdt_1h_agnostic_nan_pair1_2_zoom.png}
\caption{motif 16 matrix profile btcusdt 1h agnostic nan pair1 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_17_matrix_profile_btcusdt_1h_all_1_0_pair33_1_context.png}
\caption{motif 17 matrix profile btcusdt 1h all 1 0 pair33 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_17_matrix_profile_btcusdt_1h_all_1_0_pair33_1_normal_pattern.png}
\caption{motif 17 matrix profile btcusdt 1h all 1 0 pair33 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_17_matrix_profile_btcusdt_1h_all_1_0_pair33_1_zoom.png}
\caption{motif 17 matrix profile btcusdt 1h all 1 0 pair33 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_18_matrix_profile_btcusdt_1h_all_1_0_pair33_2_context.png}
\caption{motif 18 matrix profile btcusdt 1h all 1 0 pair33 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_18_matrix_profile_btcusdt_1h_all_1_0_pair33_2_normal_pattern.png}
\caption{motif 18 matrix profile btcusdt 1h all 1 0 pair33 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_18_matrix_profile_btcusdt_1h_all_1_0_pair33_2_zoom.png}
\caption{motif 18 matrix profile btcusdt 1h all 1 0 pair33 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_19_matrix_profile_btcusdt_1h_extreme_vol_1_0_pair73_1_context.png}
\caption{motif 19 matrix profile btcusdt 1h extreme vol 1 0 pair73 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_19_matrix_profile_btcusdt_1h_extreme_vol_1_0_pair73_1_normal_pattern.png}
\caption{motif 19 matrix profile btcusdt 1h extreme vol 1 0 pair73 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_19_matrix_profile_btcusdt_1h_extreme_vol_1_0_pair73_1_zoom.png}
\caption{motif 19 matrix profile btcusdt 1h extreme vol 1 0 pair73 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_20_matrix_profile_btcusdt_1h_extreme_vol_1_0_pair73_2_context.png}
\caption{motif 20 matrix profile btcusdt 1h extreme vol 1 0 pair73 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_20_matrix_profile_btcusdt_1h_extreme_vol_1_0_pair73_2_normal_pattern.png}
\caption{motif 20 matrix profile btcusdt 1h extreme vol 1 0 pair73 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_20_matrix_profile_btcusdt_1h_extreme_vol_1_0_pair73_2_zoom.png}
\caption{motif 20 matrix profile btcusdt 1h extreme vol 1 0 pair73 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_21_matrix_profile_btcusdt_1h_high_vol_1_0_pair13_1_context.png}
\caption{motif 21 matrix profile btcusdt 1h high vol 1 0 pair13 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_21_matrix_profile_btcusdt_1h_high_vol_1_0_pair13_1_normal_pattern.png}
\caption{motif 21 matrix profile btcusdt 1h high vol 1 0 pair13 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_21_matrix_profile_btcusdt_1h_high_vol_1_0_pair13_1_zoom.png}
\caption{motif 21 matrix profile btcusdt 1h high vol 1 0 pair13 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_22_matrix_profile_btcusdt_1h_high_vol_1_0_pair13_2_context.png}
\caption{motif 22 matrix profile btcusdt 1h high vol 1 0 pair13 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_22_matrix_profile_btcusdt_1h_high_vol_1_0_pair13_2_normal_pattern.png}
\caption{motif 22 matrix profile btcusdt 1h high vol 1 0 pair13 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_22_matrix_profile_btcusdt_1h_high_vol_1_0_pair13_2_zoom.png}
\caption{motif 22 matrix profile btcusdt 1h high vol 1 0 pair13 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_23_matrix_profile_ethusdt_15m_all_1_0_pair23_1_context.png}
\caption{motif 23 matrix profile ethusdt 15m all 1 0 pair23 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_23_matrix_profile_ethusdt_15m_all_1_0_pair23_1_normal_pattern.png}
\caption{motif 23 matrix profile ethusdt 15m all 1 0 pair23 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_23_matrix_profile_ethusdt_15m_all_1_0_pair23_1_zoom.png}
\caption{motif 23 matrix profile ethusdt 15m all 1 0 pair23 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_24_matrix_profile_ethusdt_15m_all_1_0_pair23_2_context.png}
\caption{motif 24 matrix profile ethusdt 15m all 1 0 pair23 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_24_matrix_profile_ethusdt_15m_all_1_0_pair23_2_normal_pattern.png}
\caption{motif 24 matrix profile ethusdt 15m all 1 0 pair23 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_24_matrix_profile_ethusdt_15m_all_1_0_pair23_2_zoom.png}
\caption{motif 24 matrix profile ethusdt 15m all 1 0 pair23 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_25_matrix_profile_ethusdt_15m_low_vol_1_0_pair43_1_context.png}
\caption{motif 25 matrix profile ethusdt 15m low vol 1 0 pair43 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_25_matrix_profile_ethusdt_15m_low_vol_1_0_pair43_1_normal_pattern.png}
\caption{motif 25 matrix profile ethusdt 15m low vol 1 0 pair43 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_25_matrix_profile_ethusdt_15m_low_vol_1_0_pair43_1_zoom.png}
\caption{motif 25 matrix profile ethusdt 15m low vol 1 0 pair43 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_26_matrix_profile_ethusdt_15m_low_vol_1_0_pair43_2_context.png}
\caption{motif 26 matrix profile ethusdt 15m low vol 1 0 pair43 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_26_matrix_profile_ethusdt_15m_low_vol_1_0_pair43_2_normal_pattern.png}
\caption{motif 26 matrix profile ethusdt 15m low vol 1 0 pair43 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_26_matrix_profile_ethusdt_15m_low_vol_1_0_pair43_2_zoom.png}
\caption{motif 26 matrix profile ethusdt 15m low vol 1 0 pair43 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_27_matrix_profile_ethusdt_1h_all_1_0_pair41_1_context.png}
\caption{motif 27 matrix profile ethusdt 1h all 1 0 pair41 1 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_27_matrix_profile_ethusdt_1h_all_1_0_pair41_1_normal_pattern.png}
\caption{motif 27 matrix profile ethusdt 1h all 1 0 pair41 1 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_27_matrix_profile_ethusdt_1h_all_1_0_pair41_1_zoom.png}
\caption{motif 27 matrix profile ethusdt 1h all 1 0 pair41 1 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_28_matrix_profile_ethusdt_1h_all_1_0_pair41_2_context.png}
\caption{motif 28 matrix profile ethusdt 1h all 1 0 pair41 2 context. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_28_matrix_profile_ethusdt_1h_all_1_0_pair41_2_normal_pattern.png}
\caption{motif 28 matrix profile ethusdt 1h all 1 0 pair41 2 normal pattern. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.9\linewidth]{reports/final_visual_evidence/figures/motif_28_matrix_profile_ethusdt_1h_all_1_0_pair41_2_zoom.png}
\caption{motif 28 matrix profile ethusdt 1h all 1 0 pair41 2 zoom. The shaded interval marks the discovered motif occurrence in original price context.}
\end{figure}
